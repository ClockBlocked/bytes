...
function setupCodeEditors() {
  console.log("setupCodeEditors called");
  console.log("setupCodeEditors called");
...
function deleteRepository(repoId) {
  console.log("deleteRepository called");
...
function confirmDeleteFile() {
  console.log("confirmDeleteFile called");
  console.log("confirmDeleteFile called");
  deleteCurrentFile();
  hideDeleteFileModal();
}
...
function deleteCurrentFile() {
  console.log("deleteCurrentFile called");
  console.log("deleteCurrentFile called");
...
function downloadCurrentFile() {
  console.log("downloadCurrentFile called");
  console.log("downloadCurrentFile called");
  if (!currentState.currentFile || !currentState.repository) return;
...
function viewFileFromContext(fileName) {
  console.log("viewFileFromContext called");
  hideContextMenu();
  viewFile(fileName);
}

function editFileFromContext(fileName) {
  console.log("editFileFromContext called");
  hideContextMenu();
...
function downloadFileFromContext(fileName) {
  console.log("downloadFileFromContext called");
  hideContextMenu();
  currentState.currentFile = currentState.files.find(f => f.name === fileName);
  downloadCurrentFile();
}
...
function deleteFileFromContext(fileName) {
  console.log("deleteFileFromContext called");
  hideContextMenu();
  currentState.currentFile = currentState.files.find(f => f.name === fileName);
  showDeleteFileModal();
}
...
function addToRecentFiles(fileName, repoId, repoName, filePath) {
  console.log("addToRecentFiles called");
...
function openRecentFile(repoId, filePath, fileName) {
  console.log("openRecentFile called");
  LoadingProgress.show();
...
function openRepository(repoId) {
  console.log("openRepository called");
  LoadingProgress.show();
...
function showCreateFileModal() {
  console.log("showCreateFileModal called");
  console.log("showCreateFileModal called");
...
function hideCreateFileModal() {
  console.log("hideCreateFileModal called");
  console.log("hideCreateFileModal called");
  const modal = document.getElementById("createFileModal");
...
function showDeleteFileModal() {
  console.log("showDeleteFileModal called");
  console.log("showDeleteFileModal called");
...
function showCreateRepoModal() {
  console.log("showCreateRepoModal called");
  console.log("showCreateRepoModal called");
...
function hideCreateRepoModal() {
  console.log("hideCreateRepoModal called");
  console.log("hideCreateRepoModal called");
  const modal = document.getElementById("createRepoModal");
  if (modal) modal.classList.add("hidden");
}
