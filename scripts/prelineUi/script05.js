  ...
  [874],
  {
    ...
    2757: (e, t, r) => {
      ...
      function u(e) {
        ...
        return (
          ...
          a && "#" !== a[0] && (a = "#" + a),
          c && "?" !== c[0] && (c = "?" + c),
          "" + u + f + (i = i.replace(/[?#]/g, encodeURIComponent)) + (c = c.replace("#", "%23")) + a
        );
      }
      let i = [
        "auth",
    ...
    6874: (e, t, r) => {
      ...
      function g(e) {
        ...
        (t = v), L && ("string" == typeof t || "number" == typeof t) && (t = (0, o.jsx)("a", { children: t }));
        ...
        let K = L ? r && "object" == typeof r && r.ref : M,
          B = u.default.useCallback(
            (e) => (
              ...
              () => {
                b.current && ((0, p.unmountLinkForCurrentNavigation)(b.current), (b.current = null)),
        ...
        return (
          (0, c.isAbsoluteUrl)(F)
            ? (z.href = F)
            : (L && !O && ("a" !== r.type || "href" in r.props)) || (z.href = (0, s.addBasePath)(F)),
