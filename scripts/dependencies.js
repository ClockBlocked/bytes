function isValidFilename(filename) {
  console.log("isValidFilename called");
...
function formatFileSize(bytes) {
  console.log("formatFileSize called");
...
function getLanguageColor(ext) {
  console.log("getLanguageColor called");
  const colors = {
...
function getLanguageName(ext) {
  console.log("getLanguageName called");
  const languages = {
...
function getFileIcon(filename, type) {
  console.log("getFileIcon called");
  if (type === 'folder') {
...
function getPrismLanguage(ext) {
  console.log("getPrismLanguage called");
  const languageMap = {
...
function adjustCodeBlockHeight() {
  console.log("adjustCodeBlockHeight called");
  console.log("adjustCodeBlockHeight called");
