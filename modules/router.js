...
window.showCreateFileWithoutRepository = function() {
    window.filePageMode = 'create-standalone';
...
window.showCreateFileInRepository = function() {
...
window.navigateToRoot = function() {
    ...
    if (typeof IndexedDBStorageManager !== 'undefined' && window.currentState.repository) {
