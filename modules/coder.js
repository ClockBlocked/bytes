class coderViewEdit {
  ...
  getTemplate() {
    return window.templates.editor.main();
  }

  injectPopover() {
    const temp = document.createElement('div');
    temp.innerHTML = window.templates.editor.commitDropdown();
...
//    this.elements.commitDropdown.style.display = "none";
  ...
  setLanguage(langValue) {
    ...
    this.elements.languageBadge && (this.elements.languageBadge.innerHTML = window.templates.getLanguageBadge(lang.label));
    this.elements.languageDropdown?.classList.add("hide");
