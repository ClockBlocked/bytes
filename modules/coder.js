...
<div class="fileHeader">
  ...
  <!-- Header Right - Toolbar (horizontally scrollable) -->
...
<div id="searchPanel" class="searchPanel hide">
  <div class="searchContent">
    ...
    <div class="searchControls">
      <button id="searchPrevBtn" class="searchButton" title="Previous match">
        <svg width="12" height="12" fill="currentColor" viewBox="0 0 16 16">
          <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/>
          <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8Zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z"/>
        </svg>
      </button>
      <button id="searchNextBtn" class="searchButton" title="Next match">
        <svg width="12" height="12" fill="currentColor" viewBox="0 0 16 16">
          <path d="M6 8a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>
          <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8Zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z"/>
        </svg>
      </button>
      <button id="closeSearchBtn" class="searchButton" title="Close search">
        <svg width="12" height="12" fill="currentColor" viewBox="0 0 16 16">
