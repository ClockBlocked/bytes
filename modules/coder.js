...
// Start coding here...`
  ...
  setupCodeMirror = () => {
    ...
    const config = {
      value: "",
      mode: "javascript",
      theme: isDark ? "chatgpt-dark" : "default",
    ...
    if (window.matchMedia) {
      window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', (e) => {
        if (!localStorage.getItem("editor_theme")) {
          ...
          this.updateThemeIcon(isDark);
          if (this.codeMirror) {
            this.codeMirror.setOption("theme", isDark ? "chatgpt-dark" : "default");
          }
        }
      });
    }
...
//    this.fallbackEditor.focus();
  ...
  toggleTheme = () => {
    ...
    if (this.codeMirror) {
      this.codeMirror.setOption("theme", isDark ? "default" : "chatgpt-dark");
    }
  };
